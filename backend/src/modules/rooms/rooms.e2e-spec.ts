...
describe('Rooms (e2e)', () => {
  ...
  let Authorization =
    'bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjU4MjQ5MjczMzE3OCwiaWF0IjoxNjU5MjUzMTk5LCJleHAiOjE2NTk4NTc5OTl9.SvgHat4Y8OMkeD0X1VXuRx-L-sdBqtyzWALEMnVrtHE';
  beforeAll(async () => {
